...
<form action="" method="post" enctype="multipart/form-data" id="f-guests" name="f-guests">
    ...
    <div class="row-one-column">
        ...
        <div class="cell-text">
            <input type="text" name="txt_appcode" class="my-input" <?php echo get_current_user_id() == 1 ? '' : 'readonly' ?> value="<?php echo $data['app_code'] ?>" />
        </div>
    </div>
    ...
    <div class="row-one-column">
        ...
        <div class="cell-text">
            <input type="text" name="txt_fullname" class="my-input" required value="<?php echo $data['full_name'] ?>" />
        </div>
    </div>
    ...
    <div class="row-two-column">
        ...
        <div class="col">
            ...
            <div class="cell-text"><input type="text" id="txt_position" name="txt_position" class="my-input" value='<?php echo $data['position'] ?>' /></div>
        </div>
    </div>
    ...
    <div class="row-two-column">
        <div class="col">
            ...
            <div class="cell-text">
                <input type="text" id="txt_email" name="txt_email" class="my-input email" value='<?php echo $data['email'] ?>' />
        ...
        <div class="col">
            ...
            <div class="cell-text"><input type="text" id="txt_phone" name="txt_phone" class="my-input" class='type-phone-more' value='<?php echo $data['phone']; ?>' /></div>
        </div>
    ...
    <div class="row-one-column">
        ...
        <div class="cell-text">
            <textarea id="txt_note" name="txt_note" rows="5" cols="150"><?php echo $data['note'] ?></textarea>
        </div>
    </div>
